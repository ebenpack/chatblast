(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.chatblast = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"reflux":173}],177:[function(require,module,exports){
...
var Chat = React.createClass({displayName: "Chat",
    render: function() {
        ...
        var serializedChat = chat.msg.map(function(curr){
            var output = false;
            if (curr.text){
                output = (React.createElement("span", null, curr.text));
            } else if (curr.img64){
                output = (React.createElement("img", {src: curr.img64}));
            } else if (curr.img){
                output = (React.createElement("img", {src: curr.img}));
            }
            return output;
        });
        return (
            React.createElement("div", {className: "msg"}, 
                React.createElement("div", {className: "payload"}, 
...
},{"./util":184,"react":156}],178:[function(require,module,exports){
var React = require('react');
var Reflux = require('reflux');
...
var Chatblast = React.createClass({displayName: "Chatblast",
    mixins: [
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "chatblast"}, 
        React.createElement(Chatlog, {className: chatClass, chatlog: store.chatlog, readyState: store.readyState}), 
        React.createElement(Connect, {className: connectClass, readyState: store.readyState}), 
        React.createElement(Users, {className: userClass, readyState: store.readyState, users: store.users})
      )
    );
  }
});
...
},{"./Actions":176,"./Chatlog.jsx":179,"./Connect.jsx":180,"./Store":181,"./Users.jsx":182,"react":156,"reflux":173}],179:[function(require,module,exports){
var React = require('react');
var Chat = require('./Chat.jsx');
var Actions = require('./Actions');

var Chatlog = React.createClass({displayName: "Chatlog",
  ...
  render: function() {
    return (
        React.createElement("div", {className: this.props.className + ' six columns'}, 
            React.createElement("div", {className: "textInput", contentEditable: "true", onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDrop: this.handleDrop, onKeyUp: this.handleKeyUp, onKeyDown: this.handleKeyDown, placeholder: "Type a chatblast!", ref: "msg"}
            ), 
            React.createElement("div", {className: "messages"}, 
                this.props.chatlog.map(function(chat){
                    return (React.createElement(Chat, {key: chat.time, chat: chat}));
                })
            )
        )
    );
...
},{"./Actions":176,"./Chat.jsx":177,"react":156}],180:[function(require,module,exports){
var React = require('react');
var Actions = require('./Actions');
...
var Connect = React.createClass({displayName: "Connect",
  ...
  render: function() {
    return (
        React.createElement("div", {className: this.props.className + ' twelve columns'}, 
            React.createElement("form", {onSubmit: this.handleSubmit}, 
                React.createElement("input", {placeholder: "Your name", ref: "name"}), 
...
},{"./Actions":176,"react":156}],181:[function(require,module,exports){
var Reflux = require('reflux');
var Actions = require('./Actions');
...
},{"./Actions":176,"reflux":173}],182:[function(require,module,exports){
var React = require('react');
var util = require('./util');
        ...
        return (
            React.createElement("div", {className: this.props.className + ' six columns'}, 
                this.props.users.map(function(user){
                    return (React.createElement("div", {key: user.connected}, "User ", user.name, ", connected at ", util.convertFromEpoch(user.connected)));
                })
            )
        );
    }
...
},{"./util":184,"react":156}],183:[function(require,module,exports){
var React = require('react');
var Store = require('./Store');
...
function init(domain){
    React.render(
      React.createElement(Chatblast, {domain: domain}),
...
},{"./Chatblast.jsx":178,"./Store":181,"react":156}],184:[function(require,module,exports){
