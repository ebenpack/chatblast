...
},{"./util":163,"react":156}],158:[function(require,module,exports){
var React = require('react');
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "chatblast"}, 
        React.createElement(Chatlog, {className: chatClass, chatlog: this.props.data.chatlog, readyState: this.props.data.readyState}), 
        React.createElement(Connect, {className: connectClass, readyState: this.props.data.readyState}), 
        React.createElement(Users, {className: userClass, readyState: this.props.data.readyState, users: this.props.data.users})
      )
    );
  }
});
...
},{"./Chatlog.jsx":159,"./Connect.jsx":160,"./Users.jsx":161,"react":156}],159:[function(require,module,exports){
var React = require('react');
        ...
        React.createElement("div", {className: this.props.className + ' six columns'}, 
            ...
            React.createElement("div", {className: "messages"}, 
                this.props.chatlog.map(function(chat){
                    return (React.createElement(Chat, {chat: chat}));
                })
            )
        )
    );
...
},{"./Chat.jsx":157,"react":156}],160:[function(require,module,exports){
var React = require('react');
        ...
        return (
            React.createElement("div", {className: this.props.className + ' six columns'}, 
                this.props.users.map(function(user){
                    return (React.createElement("div", null, "User ", user.name, ", connected at ", util.convertFromEpoch(user.connected)));
                })
            )
        );
    }
...
},{"./util":163,"react":156}],162:[function(require,module,exports){
var React = require('react');
var Chatblast = require('./Chatblast.jsx');

function init(state){
    React.render(
      React.createElement(Chatblast, {data: state}),
...
},{"./Chatblast.jsx":158,"react":156}],163:[function(require,module,exports){
